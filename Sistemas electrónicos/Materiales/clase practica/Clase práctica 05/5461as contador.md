...
<img src="C:\Users\ingga\OneDrive - UNP Universidad Nacional Politécnica\Clases\Materias\Sistemas electrónicos\5461aspng.png" align="left" width="250" style="margin-right: 20px;">
...
const byte numeros[10] = {// el prerfijo 0b indica al compilador que el arreglo contiene número binario
  0b00111111, // 0
  0b00000110, // 1
  0b01011011, // 2
  0b01001111, // 3
  ...
  0b01111111, // 8
  0b01101111  // 9
};// se almacenan un byte binario para controlar cada sermento A,B,C,D,E,F,G,DP
